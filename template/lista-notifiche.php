        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-6 d-grid mb-3">
                    <button class="btn btn-primary rounded-pill px-4 btn-messaggi-inviati d-none">Mostra Messaggi Inviati</button>
                    <button class="btn btn-primary rounded-pill px-4 btn-messaggi-ricevuti">Mostra Messaggi Ricevuti</button>
                </div>
        ...
        <?php else: ?>
            <?php foreach ($templateParams["messaggi_inviati"] as $messaggioInviato): ?>
                <article class="px-4 py-3 card mb-4 shadow-sm border-0 border-start border-4 border-primary">
                    <div>
                        <h2 class="h5"><?php echo $messaggioInviato["email"]; ?></h2>
                    </div>
    ...
    <section class="messaggi-ricevuti d-none" >
        ...
        <?php else: ?>
            <?php foreach ($templateParams["messaggi_ricevuti"] as $messaggioRicevuto): ?>
                <article class="px-4 py-3 card mb-4 shadow-sm border-0 border-start border-4 border-primary">
                    <div>
                        <h2 class="h5"><?php echo $messaggioRicevuto["email"]; ?></h2>
                    </div>
