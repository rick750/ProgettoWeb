...
("elena.bianchi@studio.unibo.it",3,
"giorgio.bianchi@studio.unibo.it",1,
"Ti consiglio \'White Lights\'");

INSERT INTO COMMENTO VALUES 
("davide.lombardi@studio.unibo.it",4,
"francesco.gallo@studio.unibo.it",1,
"Nei livelli aperti io preferisco lo stealth quando voglio pianificare con calma, mentre scelgo l’approccio aggressivo se punto su azione diretta e decisioni rapide.\r\n");

INSERT INTO COMMENTO VALUES
("davide.lombardi@studio.unibo.it",4,
"riccardo.carta2@studio.unibo.it",2,
"Io in genere parto sempre con un approccio stealth e se necessario poi provo più aggressivo");
